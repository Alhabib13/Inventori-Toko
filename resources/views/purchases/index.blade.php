...
@section('content')
    <section class="rounded-2xl bg-white p-6 shadow-sm">
        ...
        <p class="mt-1 text-sm text-slate-600">Riwayat pembelian dari supplier.</p>
        ...
        <div class="mt-4">
            <a href="{{ route('purchases.create') }}" class="inline-flex rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white">
                Tambah Pembelian
            </a>
        </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($purchases as $purchase)
                        <tr>
                            ...
                            <td class="py-3 pr-4">{{ ucfirst($purchase->status) }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="py-6 text-center text-slate-500">Belum ada pembelian.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
