...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <div class="space-y-2">
        ...
        <input id="nama_supplier" name="nama_supplier" type="text" value="{{ old('nama_supplier', $supplier?->nama_supplier) }}" required class="h-11 w-full rounded-lg border border-[#c0c8cb] bg-white px-4 text-sm text-slate-700 outline-none transition focus:border-[#003441] focus:ring-2 focus:ring-[#003441]/10" />
    </div>

    <div class="space-y-2">
        <label for="nama_kontak" class="text-[11px] font-bold uppercase tracking-[0.18em] text-slate-500">Nama Kontak</label>
        <input id="nama_kontak" name="nama_kontak" type="text" value="{{ old('nama_kontak', $supplier?->nama_kontak) }}" required class="h-11 w-full rounded-lg border border-[#c0c8cb] bg-white px-4 text-sm text-slate-700 outline-none transition focus:border-[#003441] focus:ring-2 focus:ring-[#003441]/10" />
    </div>

    <div class="space-y-2">
        <label for="email" class="text-[11px] font-bold uppercase tracking-[0.18em] text-slate-500">Email</label>
        <input id="email" name="email" type="email" value="{{ old('email', $supplier?->email) }}" class="h-11 w-full rounded-lg border border-[#c0c8cb] bg-white px-4 text-sm text-slate-700 outline-none transition focus:border-[#003441] focus:ring-2 focus:ring-[#003441]/10" />
    </div>

    <div class="space-y-2">
        <label for="telepon" class="text-[11px] font-bold uppercase tracking-[0.18em] text-slate-500">Telepon</label>
        <input id="telepon" name="telepon" type="text" value="{{ old('telepon', $supplier?->telepon) }}" required class="h-11 w-full rounded-lg border border-[#c0c8cb] bg-white px-4 text-sm text-slate-700 outline-none transition focus:border-[#003441] focus:ring-2 focus:ring-[#003441]/10" />
    </div>
</div>

<div class="space-y-2">
    <label for="alamat" class="text-[11px] font-bold uppercase tracking-[0.18em] text-slate-500">Alamat</label>
    <textarea id="alamat" name="alamat" rows="4" required class="w-full rounded-lg border border-[#c0c8cb] bg-white px-4 py-3 text-sm text-slate-700 outline-none transition focus:border-[#003441] focus:ring-2 focus:ring-[#003441]/10">{{ old('alamat', $supplier?->alamat) }}</textarea>
</div>

<div class="space-y-2">
    <label for="keterangan" class="text-[11px] font-bold uppercase tracking-[0.18em] text-slate-500">Keterangan</label>
    <textarea id="keterangan" name="keterangan" rows="3" class="w-full rounded-lg border border-[#c0c8cb] bg-white px-4 py-3 text-sm text-slate-700 outline-none transition focus:border-[#003441] focus:ring-2 focus:ring-[#003441]/10">{{ old('keterangan', $supplier?->keterangan) }}</textarea>
</div>
