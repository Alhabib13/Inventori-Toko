...
@section('content')
    <div class="rounded-2xl border border-slate-200 bg-white px-5 py-6 shadow-sm sm:px-6">
        ...
        <form action="{{ route('password.owner.update') }}" method="POST" class="mt-6 space-y-4">
            @csrf
            ...
            <div class="space-y-1.5">
                ...
                <div class="flex gap-2">
                    ...
                    <button
                        type="submit"
                        formaction="{{ route('password.owner.email') }}"
                        formmethod="POST"
                        formnovalidate
            ...
            <button type="submit" data-loading-text="Reset sandi owner..." class="h-11 w-full rounded-md bg-[#083d4b] text-sm font-bold text-white transition hover:bg-[#062f39]">
                Reset Sandi Owner
            </button>
