...
@section('auth_features')
    <div class="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/10 px-4 py-4 backdrop-blur-sm">
        ...
        <div>
            ...
            <p class="mt-1 text-sm leading-6 text-slate-300">Cocok untuk toko kecil dengan alur kasir yang cepat dan struktur tim ringkas.</p>
        </div>
    </div>
    <div class="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/10 px-4 py-4 backdrop-blur-sm">
        <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white/10">
        ...
        <div>
            ...
            <p class="mt-1 text-sm leading-6 text-slate-300">Cocok untuk toko dengan proses stok lebih detail dan kebutuhan operasional yang lebih besar.</p>
        </div>
    </div>
@endsection
            ...
            <label class="block cursor-pointer rounded-2xl border border-slate-200 bg-white p-5 transition hover:border-[#163760]/35">
                ...
                <div class="flex items-start justify-between gap-4">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm leading-6 text-slate-500">Untuk toko kecil. Fokus pada owner dan kasir dengan alur operasional yang lebih ringkas.</p>
                    </div>
            ...
            <label class="block cursor-pointer rounded-2xl border border-slate-200 bg-white p-5 transition hover:border-[#163760]/35">
                ...
                <div class="flex items-start justify-between gap-4">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm leading-6 text-slate-500">Untuk toko dengan pengelolaan stok yang lebih detail dan potensi struktur tim yang lebih lengkap.</p>
                    </div>
                    <span class="mt-1 h-5 w-5 rounded-full border border-slate-300"></span>
                </div>
            </label>
